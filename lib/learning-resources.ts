...
export type LearningResource = {
  id: string;
  domain: V2Domain;
  resourceType: "video" | "documentation" | "article" | "course" | "practice_problem" | "interactive" | "project";
  titleEn: string;
  titleUz: string;
  url: string;
...
const resourceSeeds: ResourceSeed[] = [
  ...
  { id: "leetcode-two-sum", domain: "Programming Fundamentals", resourceType: "practice_problem", titleEn: "LeetCode 1: Two Sum", titleUz: "LeetCode 1: Two Sum masalasi", url: "https://leetcode.com/problems/two-sum/" },
  ...
  { id: "leetcode-binary-search", domain: "Computational Thinking & Algorithms", resourceType: "practice_problem", titleEn: "LeetCode 704: Binary Search", titleUz: "LeetCode 704: Binary Search masalasi", url: "https://leetcode.com/problems/binary-search/" },
  { id: "leetcode-valid-parentheses", domain: "Computational Thinking & Algorithms", resourceType: "practice_problem", titleEn: "LeetCode 20: Valid Parentheses", titleUz: "LeetCode 20: Valid Parentheses masalasi", url: "https://leetcode.com/problems/valid-parentheses/" },
...
export const learningResources: LearningResource[] = resourceSeeds.map((resource) => ({
  ...
  difficulty: resource.resourceType === "practice_problem" ? "standard" : "foundation",
